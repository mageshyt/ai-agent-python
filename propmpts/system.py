...
def get_compression_prompt(n: int) -> str:
    return f"""You are a high-precision conversation summarizer.

Below are {n} messages from a conversation.

Summarize them into ONE dense paragraph that preserves:
- Decisions made
- Final conclusions
