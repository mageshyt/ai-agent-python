...
def _truncate_by_lines(text:str, allowed_tokens:int, model:str, suffix:str) -> str:
...
def _truncate_by_chars(text:str, allowed_tokens:int, model:str, suffix:str) -> str:
    low,high = 0, len(text)
